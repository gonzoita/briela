    ...
    <AppLayout title="Nuevo Colaborador">
        <div class="max-w-lg mx-auto">
            ...
            <div class="flex items-center gap-3 mb-5">
                ...
                <h1 class="text-xl font-bold text-gray-900">Nuevo Colaborador</h1>
            </div>
            ...
            <div v-show="seccion === 'seguridad'" class="bg-white rounded-2xl border border-gray-200 p-5 space-y-4">
                <p class="text-xs text-gray-400">Los documentos se pueden cargar después de crear el colaborador.</p>
