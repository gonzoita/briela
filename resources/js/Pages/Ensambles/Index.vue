    ...
    <AppLayout title="Ensambles">
        <div class="max-w-5xl mx-auto">
            ...
            <div v-if="ensambles.data?.length === 0" class="bg-superficie rounded-2xl shadow-sm py-16 text-center text-tinta-300">
                ...
                <p class="text-sm">Sin ensambles. <a href="/ensambles/crear" class="text-aviso-azul hover:underline" @click.prevent="router.visit('/ensambles/crear')">Crea el primero</a>.</p>
            </div>
