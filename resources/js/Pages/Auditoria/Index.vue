    ...
    <AppLayout title="Auditoría">
        <div class="max-w-6xl mx-auto">
            ...
            <div class="flex items-center justify-between mb-4">
                <div>
                    <h1 class="text-lg font-bold text-gray-900">Bitácora de actividad</h1>
                    <p class="text-xs text-gray-400 mt-0.5">Registro de acciones de los usuarios: creación, edición, movimiento y eliminación de datos.</p>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl border border-gray-200 divide-y divide-gray-50">
                <div v-if="registros.data.length === 0" class="px-4 py-12 text-center text-gray-400 text-sm">
                ...
                <div v-for="r in registros.data" :key="r.id" class="px-4 py-3 flex items-start gap-3">
                    ...
                    <div class="min-w-0 flex-1">
                        <p class="text-sm text-gray-800">{{ r.descripcion }}</p>
            ...
            <div v-if="registros.links?.length > 3" class="flex flex-wrap gap-1 justify-center mt-4">
                <button v-for="(link, i) in registros.links" :key="i"
                    ...
                    :class="link.active ? 'text-white' : 'text-gray-500 hover:bg-gray-100'"
