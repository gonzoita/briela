    ...
    <AppLayout :title="`Editar ${remision.numero}`">
        <div class="max-w-xl mx-auto">
            ...
            <div class="flex items-center gap-3 mb-6">
                <a :href="`/logistica/remisiones/${remision.id}`" class="text-gray-400 hover:text-gray-700">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"/>
                    </svg>
                </a>
                <h1 class="text-xl font-bold text-gray-900">Editar {{ remision.numero }}</h1>
            </div>
            ...
            <div class="bg-white rounded-2xl border border-gray-200 p-5 space-y-4">
                ...
                <div>
                    ...
                    <textarea v-model="form.notas" rows="3"
                        class="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none resize-none"/>
                </div>
