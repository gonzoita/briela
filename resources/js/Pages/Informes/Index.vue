    ...
    <AppLayout title="Informes">
        <div class="max-w-5xl mx-auto">
            ...
            <div class="flex items-center justify-between mb-6">
                <div>
                    <h1 class="text-xl font-bold text-gray-900">Informes Dinámicos</h1>
                    <p class="text-sm text-gray-500 mt-0.5">Construye y ejecuta informes personalizados</p>
                </div>
                <a
                    href="/informes/crear"
            ...
            <div v-if="!informes.length" class="text-center py-20">
                <div class="w-16 h-16 mx-auto mb-4 rounded-2xl flex items-center justify-center" style="background:#EFF6FF;">
                    <svg class="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="#0A4283" stroke-width="1.5">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                    </svg>
                </div>
                <p class="text-gray-500 text-sm">No hay informes todavía.</p>
                ...
                >
                    ...
                    <div class="flex items-center gap-2">
                        <span
                            ...
                            :class="fuenteConfig[informe.fuente]?.color ?? 'bg-gray-100 text-gray-600'"
                        >
                    ...
                    <div>
                        <h2 class="text-sm font-bold text-gray-900">{{ informe.nombre }}</h2>
                        <p v-if="informe.descripcion" class="text-xs text-gray-500 mt-0.5 line-clamp-2">
                            {{ informe.descripcion }}
                        </p>
                    </div>
                    ...
                    <div class="flex items-center justify-between pt-1 border-t border-gray-50 mt-auto">
                        <span class="text-xs text-gray-400">{{ informe.created_at }}</span>
