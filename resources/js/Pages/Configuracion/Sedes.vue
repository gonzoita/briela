    ...
    <AppLayout title="Sedes">
        <div class="max-w-3xl mx-auto">
            ...
            <div class="flex items-center gap-3 mb-5">
                ...
                <h1 class="text-xl font-bold text-gray-900">Sedes</h1>
            </div>

            <!-- Lista -->
            <div class="bg-white rounded-2xl border border-gray-200 overflow-hidden mb-4">
                <div class="px-5 py-3 border-b border-gray-100">
                    <h2 class="text-sm font-semibold text-gray-700">Sedes registradas</h2>
                    <p class="text-xs text-gray-400 mt-0.5">
                        Una sede puede ser solo de ventas, solo fábrica, o las dos cosas.
                    </p>
                </div>

                <div v-if="!sedes.length" class="py-10 text-center text-sm text-gray-400">
                    ...
                    <div v-for="s in sedes" :key="s.id" class="px-4 py-3">
                        <div class="flex items-center gap-3">
                            <div class="w-9 h-9 rounded-xl flex items-center justify-center shrink-0"
                                :class="s.activa ? 'bg-blue-50' : 'bg-gray-100'">
                                <svg class="w-4 h-4" :class="s.activa ? 'text-[var(--marca)]' : 'text-gray-400'"
                            ...
                            <div class="flex-1 min-w-0">
                                <div class="flex items-center gap-2 flex-wrap">
                                    <p class="text-sm font-medium text-gray-800 truncate">{{ s.nombre }}</p>
                                    <span class="text-xs font-mono px-1.5 py-0.5 rounded bg-gray-100 text-gray-600">{{ s.codigo }}</span>
                                </div>
                            ...
                            <span class="text-xs px-2 py-0.5 rounded-full shrink-0"
                                :class="s.activa ? 'bg-green-100 text-green-700' : 'bg-gray-100 text-gray-500'">
            ...
            <div class="bg-white rounded-2xl border border-gray-200 p-5">
                ...
                <div class="space-y-3">
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
                        ...
                        <div>
                            ...
                            <input v-model="form.codigo" type="text" maxlength="10" placeholder="CAL"
                                class="w-full rounded-xl border border-gray-300 px-3 py-2 text-sm uppercase focus:outline-none focus:ring-2 focus:ring-blue-500" />
                            <p class="text-xs text-gray-400 mt-1">Se usa en los códigos de documentos.</p>
                        </div>
                    </div>

                    <!-- Qué hace la sede -->
                    <div class="rounded-xl bg-gray-50 p-3">
                        <p class="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">¿Qué se hace en esta sede?</p>
                        <label class="flex items-center gap-2 cursor-pointer py-1">
                            <input v-model="form.tiene_ventas" type="checkbox" class="rounded" />
                            <span class="text-sm text-gray-700">Ventas (clientes, cotizaciones)</span>
                        </label>
                        <label class="flex items-center gap-2 cursor-pointer py-1">
                            <input v-model="form.tiene_produccion" type="checkbox" class="rounded" />
                            <span class="text-sm text-gray-700">Fábrica (órdenes de producción, trabajos)</span>
                        </label>
                    </div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        ...
                        <div>
                            <label class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1.5">NIT</label>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        ...
                        <div>
                            <label class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1.5">Correo</label>
                    ...
                    <div class="flex flex-col gap-2">
                        <label class="flex items-center gap-2 cursor-pointer">
                            ...
                            <span class="text-sm text-gray-700">Sede principal (reemplaza a la actual)</span>
                        </label>
                        <label class="flex items-center gap-2 cursor-pointer">
