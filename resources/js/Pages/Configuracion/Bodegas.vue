    ...
    <AppLayout title="Bodegas">
        <div class="max-w-3xl mx-auto">
            ...
            <div class="flex items-center gap-3 mb-5">
                ...
                <h1 class="text-xl font-bold text-gray-900">Bodegas</h1>
            </div>

            <!-- Lista -->
            <div class="bg-white rounded-2xl border border-gray-200 overflow-hidden mb-4">
                <div class="px-5 py-3 border-b border-gray-100">
                    <h2 class="text-sm font-semibold text-gray-700">Bodegas registradas</h2>
                    <p class="text-xs text-gray-400 mt-0.5">Cada sede puede tener su propia bodega Principal.</p>
                </div>

                <div v-if="!bodegas.length" class="py-10 text-center text-sm text-gray-400">
                ...
                <div class="divide-y divide-gray-50">
                    ...
                    >
                        ...
                        <div class="w-9 h-9 rounded-xl flex items-center justify-center shrink-0"
                            :class="b.activa ? 'bg-blue-50' : 'bg-gray-100'"
                        >
                            <svg class="w-4 h-4" :class="b.activa ? 'text-[var(--marca)]' : 'text-gray-400'"
                        ...
                        <div class="flex-1 min-w-0">
                            <p class="text-sm font-medium text-gray-800 truncate">{{ b.nombre }}</p>
                            <p class="text-xs text-gray-400">
                                <span v-if="b.sede" class="font-medium text-gray-500">{{ b.sede.nombre }}</span>
                        ...
                        <span
                            ...
                            :class="b.activa ? 'bg-green-100 text-green-700' : 'bg-gray-100 text-gray-500'"
                        >
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex flex-col gap-2">
                        <label class="flex items-center gap-2 cursor-pointer">
                            ...
                            <span class="text-sm text-gray-700">Bodega principal de esta sede</span>
                        </label>
                        <label class="flex items-center gap-2 cursor-pointer">
