    ...
    <AppLayout title="Numeración de documentos">
        <div class="max-w-3xl mx-auto">
            ...
            <div class="flex items-center gap-3 mb-5">
                ...
                <h1 class="text-xl font-bold text-gray-900">Numeración</h1>
            </div>
            ...
            <!-- Documentos -->
            <div class="space-y-3">
                <div v-for="f in filasDeSede" :key="f.id" class="bg-white rounded-2xl border border-gray-200 p-4">
                    <div class="flex items-center justify-between mb-3">
                        <h3 class="text-sm font-semibold text-gray-800">{{ f.tipo_label }}</h3>
                        <span class="text-xs font-mono px-2 py-1 rounded-lg bg-gray-100 text-gray-700">
                            {{ ejemplo(f) }}
                        </span>
                    </div>
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-3 gap-3">
                        <div class="col-span-2 sm:col-span-1">
                            <label class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1.5">Prefijo</label>
                        ...
                        <div>
                            <label class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1.5">Siguiente</label>
                            <input v-model.number="f.siguiente_numero" type="number" min="1"
                                class="w-full rounded-xl border border-gray-300 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500" />
                        </div>
                        <div>
                            <label class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1.5">Ceros</label>
                    ...
                    <div class="flex items-center justify-between mt-3">
                        <label class="flex items-center gap-2 cursor-pointer">
                            ...
                            <span class="text-sm text-gray-700">Incluir el año</span>
                        </label>
            ...
            <div v-if="!filasDeSede.length" class="py-10 text-center text-sm text-gray-400">
