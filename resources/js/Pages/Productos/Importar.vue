    ...
    <AppLayout title="Importar productos">
        <div class="max-w-3xl mx-auto">
            ...
            <div class="flex items-center gap-3 mb-4">
                <button class="text-gray-400 hover:text-gray-700" @click="router.visit('/productos')">
            ...
            <div v-if="resultado" class="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 mb-4">
                ...
                <div v-if="resultado.categorias_creadas.length" class="text-xs text-gray-500 mb-2">
                    Categorías nuevas: <span class="font-medium text-gray-700">{{ resultado.categorias_creadas.join(', ') }}</span>
                </div>
                <div v-if="resultado.proveedores_creados.length" class="text-xs text-gray-500 mb-2">
                    Proveedores nuevos: <span class="font-medium text-gray-700">{{ resultado.proveedores_creados.join(', ') }}</span>
                </div>
