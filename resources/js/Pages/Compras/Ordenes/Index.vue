        ...
        <div class="max-w-5xl mx-auto px-4 py-4">
            ...
            <div class="bg-white rounded-xl border border-gray-200 p-3 mb-4">
                <div class="flex flex-col sm:flex-row gap-2 flex-wrap">
                    ...
                    <select v-model="proveedor_id" class="rounded-lg border border-gray-300 px-3 py-2 text-sm" @change="aplicarFiltros">
            ...
            <div class="space-y-2">
                <a v-for="o in ordenes.data" :key="o.id"
                    ...
                    class="block bg-white rounded-xl border border-gray-200 p-4 hover:border-blue-300 transition-colors">
                    <div class="flex items-start justify-between">
                        <div>
                            <div class="flex items-center gap-2 mb-1">
                                <p class="font-bold text-gray-900">{{ o.numero }}</p>
                            ...
                            <p class="text-sm text-gray-600">{{ o.proveedor?.nombre }}</p>
                        ...
                        <div class="text-right">
                            <p class="font-bold text-gray-900">{{ fmtMoney(o.total) }}</p>
                            <p class="text-xs text-gray-400">{{ new Date(o.created_at).toLocaleDateString('es-CO') }}</p>
                        </div>
                    </div>
                </a>

                <div v-if="!ordenes.data?.length" class="text-center py-8 text-gray-400">
