    ...
    <AppLayout title="Nuevo mantenimiento">
        <div class="max-w-2xl mx-auto">
            ...
            <div class="flex items-center gap-3 mb-5">
                ...
                <h1 class="text-xl font-bold text-gray-900">Registrar Mantenimiento</h1>
            </div>
            ...
            <div class="bg-white rounded-2xl border border-gray-200 p-5 mb-4 space-y-4">
                ...
                <div class="grid grid-cols-2 gap-3">
                    ...
                    <div>
                        <label class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1.5">Tiempo (horas)</label>
                ...
                <div>
                    <label class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1.5">Acciones realizadas</label>
            ...
            <div class="bg-white rounded-2xl border border-gray-200 overflow-hidden mb-4">
                ...
                <div v-if="!form.repuestos.length" class="py-6 text-center text-xs text-gray-400">Sin repuestos.</div>
                <div class="divide-y divide-gray-50">
                    <div v-for="(r, idx) in form.repuestos" :key="idx" class="p-4 space-y-2">
                        ...
                        <p class="text-xs text-right text-gray-500 font-medium">
            ...
            <div class="bg-blue-50 rounded-2xl border border-blue-200 p-4 mb-4">
                ...
                <div class="flex justify-between text-base font-bold mt-2 pt-2 border-t border-blue-200">
                    <span>Total</span>
