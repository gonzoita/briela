    ...
    <AppLayout :title="`Editar: ${equipo.nombre}`">
        <div class="max-w-2xl mx-auto">
            ...
            <div class="flex items-center gap-3 mb-5">
                ...
                <h1 class="text-xl font-bold text-gray-900">Editar Equipo</h1>
            </div>
            ...
            <div class="bg-white rounded-2xl border border-gray-200 p-5 mb-4 space-y-4">
                <div class="grid grid-cols-2 gap-3">
                    ...
                    <div>
                        <label class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1.5">Frec. (días)</label>
            ...
            <div class="bg-white rounded-2xl border border-gray-200 overflow-hidden mb-4">
                ...
                <div v-if="!form.componentes.length" class="py-6 text-center text-xs text-gray-400">Sin componentes.</div>
