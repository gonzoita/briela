...
<template>
    <section>
        <header>
            <h2 class="text-lg font-medium text-tinta-900">
                Profile Information
            </h2>
        ...
        >
            ...
            <div v-if="mustVerifyEmail && user.email_verified_at === null">
                <p class="mt-2 text-sm text-tinta-900">
                ...
                <div
                    ...
                    class="mt-2 text-sm font-medium text-aviso-verde"
                >
