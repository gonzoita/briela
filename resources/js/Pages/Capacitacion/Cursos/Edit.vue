    ...
    <AppLayout title="Editar curso">
        <div class="max-w-2xl mx-auto">
            ...
            <div class="flex items-center gap-3 mb-5">
                <button @click="router.visit(`/capacitacion/cursos/${curso.id}`)" class="w-9 h-9 rounded-xl flex items-center justify-center text-tinta-400 hover:bg-tinta-100 transition-colors shrink-0">
                    <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.6">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M15 19l-7-7 7-7"/>
                    </svg>
                </button>
                <h1 class="text-xl font-semibold text-tinta-900">Editar curso</h1>
            </div>
            ...
            <form @submit.prevent="submit" class="space-y-4">
                <div class="bg-superficie rounded-2xl shadow-sm p-5 space-y-4">
                    ...
                    <label class="flex items-center gap-2 cursor-pointer">
                        ...
                        <span class="text-sm text-tinta-700">Curso obligatorio (asignación por administrador)</span>
                    </label>
                ...
                <div class="bg-superficie rounded-2xl shadow-sm p-5">
                    ...
                    <div class="flex items-center gap-3">
                        <div class="w-24 h-16 rounded-xl overflow-hidden bg-tinta-50 border border-linea flex items-center justify-center shrink-0">
                            ...
                            <svg v-else class="w-6 h-6 text-tinta-200" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-tinta-300 mt-1.5 leading-snug">
