    ...
    <AppLayout title="Invitaciones">
        <div class="max-w-4xl mx-auto">
            ...
            <div v-if="invitaciones.length === 0" class="bg-superficie rounded-2xl shadow-sm py-16 text-center text-tinta-300">
                ...
                <p class="text-sm">Sin invitaciones. <a href="#" @click.prevent="abrirModal" class="text-aviso-azul hover:underline">Crea la primera</a>.</p>
            </div>
                    ...
                    <div class="flex items-center gap-3 flex-wrap">
                        ...
                        <div class="flex items-center gap-1.5 shrink-0">
                            ...
                            <button v-if="!inv.usado_at" @click="cancelar(inv)"
                                class="w-8 h-8 rounded-lg flex items-center justify-center text-tinta-300 hover:text-aviso-rojo hover:bg-pastel-rojo transition-colors">
            ...
            <div class="relative bg-superficie w-full sm:max-w-md sm:rounded-2xl rounded-t-2xl shadow-xl max-h-[90vh] overflow-y-auto">
                ...
                <div class="p-5 space-y-4">
                    <div>
                        ...
                        <p v-if="form.errors.email" class="text-xs text-aviso-rojo mt-1">{{ form.errors.email }}</p>
                    </div>
