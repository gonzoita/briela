        ...
        <Teleport to="body">
            <div v-if="modalIa" class="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-4"
                ...
                <div class="bg-superficie rounded-2xl shadow-xl w-full max-w-sm p-5">
                    ...
                    <p v-if="iaError" class="text-xs text-aviso-rojo mb-3">{{ iaError }}</p>
                    ...
                    <tr v-for="archivo in archivos.data" :key="archivo.id" class="hover:bg-tinta-50 transition-colors">
                        ...
                        <td class="px-4 py-3 text-right">
                            <div class="flex items-center justify-end gap-1">
                                <a :href="archivo.url" target="_blank" class="w-7 h-7 rounded-lg flex items-center justify-center text-tinta-300 hover:text-aviso-azul hover:bg-realce transition-colors">
                                    <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.6">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"/>
                                    </svg>
                                </a>
                                <button @click="eliminar(archivo)" class="w-7 h-7 rounded-lg flex items-center justify-center text-tinta-300 hover:text-aviso-rojo hover:bg-pastel-rojo transition-colors">
                                    <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.6">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"/>
                                    </svg>
                                </button>
