...
async function compartir() {
    ...
    const text = `${props.producto.nombre} — Interfrigo SAS`
    if (navigator.share) {
        ...
        <header class="bg-white border-b border-gray-200 sticky top-0 z-20">
            <div class="max-w-5xl mx-auto px-4 py-3 flex items-center justify-between">
                <div class="flex items-center gap-2">
                    ...
                    <span class="text-xs text-gray-400 hidden sm:inline">Catálogo de Productos</span>
                </div>
                <div class="flex items-center gap-2">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div class="space-y-5">
                    <div>
                        ...
                        <p class="text-sm text-gray-400 mt-1">Ref: {{ producto.referencia }} · {{ producto.unidad_medida }}</p>
                    </div>

                    <div v-if="producto.descripcion_corta" class="text-gray-600 text-sm leading-relaxed">
                    ...
                    <div v-if="producto.descripcion_larga"
                        ...
                        <h3 class="text-xs font-bold text-gray-500 uppercase tracking-wider mb-2">Descripción técnica</h3>
                        <div class="tiptap-content text-sm text-gray-600 leading-relaxed" v-html="producto.descripcion_larga"></div>
                    </div>
