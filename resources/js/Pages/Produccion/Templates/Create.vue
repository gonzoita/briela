    ...
    <AppLayout title="Nuevo Template">
        ...
        <div class="max-w-2xl mx-auto sm:max-w-4xl">
            ...
            <div class="flex items-center gap-3 mb-4">
                ...
                <h1 class="text-xl font-bold text-gray-900">Nuevo Template de Trabajo</h1>
            </div>
                    ...
                    <div v-else-if="form.pasos[pasoActivo]"
                        ...
                        <div>
                            <label class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1.5">
                                Descripción <span class="text-gray-400 font-normal">(usa {variable} para reemplazar al iniciar)</span>
                            </label>
