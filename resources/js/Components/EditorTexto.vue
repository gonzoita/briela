...
<template>
    <div class="border border-gray-300 rounded-xl overflow-hidden focus-within:ring-2 focus-within:ring-blue-400 focus-within:border-blue-400 transition-colors bg-white">
        <!-- Toolbar -->
        <div class="flex flex-wrap gap-0.5 p-1.5 border-b border-gray-200 bg-gray-50">
            ...
            <button type="button"
                ...
                :class="['p-1.5 rounded hover:bg-gray-200 transition-colors', editor?.isActive('bold') ? 'bg-[var(--marca)] text-white' : 'text-gray-600']"
                title="Negrita">
            ...
            <button type="button"
                ...
                :class="['p-1.5 rounded hover:bg-gray-200 transition-colors', editor?.isActive('italic') ? 'bg-[var(--marca)] text-white' : 'text-gray-600']"
                title="Cursiva">
                <svg class="w-3.5 h-3.5" viewBox="0 0 24 24" fill="currentColor">
            ...
            <button type="button"
                ...
                :class="['p-1.5 rounded hover:bg-gray-200 transition-colors', editor?.isActive('underline') ? 'bg-[var(--marca)] text-white' : 'text-gray-600']"
                title="Subrayado">
                <svg class="w-3.5 h-3.5" viewBox="0 0 24 24" fill="currentColor">
            ...
            <button type="button"
                ...
                :class="['p-1.5 rounded hover:bg-gray-200 transition-colors', editor?.isActive('bulletList') ? 'bg-[var(--marca)] text-white' : 'text-gray-600']"
            ...
            <button type="button"
                ...
                :class="['p-1.5 rounded hover:bg-gray-200 transition-colors', editor?.isActive('orderedList') ? 'bg-[var(--marca)] text-white' : 'text-gray-600']"
            ...
            <button type="button"
                ...
                :class="['p-1.5 rounded hover:bg-gray-200 transition-colors', editor?.isActive({ textAlign: 'left' }) ? 'bg-[var(--marca)] text-white' : 'text-gray-600']"
            ...
            <button type="button"
                ...
                :class="['p-1.5 rounded hover:bg-gray-200 transition-colors', editor?.isActive({ textAlign: 'center' }) ? 'bg-[var(--marca)] text-white' : 'text-gray-600']"
                title="Centrar">
                <svg class="w-3.5 h-3.5" viewBox="0 0 24 24" fill="currentColor">
            ...
            <button type="button"
                ...
                :class="['p-1.5 rounded hover:bg-gray-200 transition-colors', editor?.isActive({ textAlign: 'right' }) ? 'bg-[var(--marca)] text-white' : 'text-gray-600']"
            ...
            <button type="button"
                ...
                :class="['p-1.5 rounded hover:bg-gray-200 transition-colors', editor?.isActive('link') ? 'bg-[var(--marca)] text-white' : 'text-gray-600']"
                title="Enlace">
                <svg class="w-3.5 h-3.5" viewBox="0 0 24 24" fill="currentColor">
        ...
        <EditorContent
            ...
            class="px-3 py-2 text-sm text-gray-800 [&_.ProseMirror]:outline-none [&_.ProseMirror]:min-h-[inherit]"
        />
        <!-- Counter (only when maxLength is set) -->
        <div v-if="maxLength" class="px-3 py-1 border-t border-gray-100 flex justify-end bg-white">
            <span class="text-xs tabular-nums"
                :class="charCount > maxLength ? 'text-red-500 font-semibold' : charCount > maxLength * 0.9 ? 'text-amber-500 font-semibold' : 'text-gray-400'">
