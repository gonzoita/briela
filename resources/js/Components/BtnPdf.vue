...
<template>
    <div class="relative flex items-center" data-btn-pdf>
        ...
        >
            ...
            <div v-if="cargando" class="px-3 py-3 text-xs text-tinta-300 text-center">
                Cargando...
            </div>
            <div v-else-if="!plantillas.length" class="px-3 py-3 text-xs text-tinta-300 text-center">
            ...
            <a v-for="p in plantillas" :key="p.id"
                ...
                target="_blank"
                @click="abierto = false"
                class="flex items-center justify-between px-3 py-2 hover:bg-tinta-50 text-sm text-tinta-700"
            >
                <span>{{ p.nombre }}</span>
