...
return new class extends Migration {
    ...
    {
        $claves = [
            ['clave' => 'empresa_nombre',    'valor' => '', 'tipo' => 'string', 'grupo' => 'empresa', 'etiqueta' => 'Nombre de la empresa'],
            ['clave' => 'empresa_nit',       'valor' => '',               'tipo' => 'string', 'grupo' => 'empresa', 'etiqueta' => 'NIT'],
            ['clave' => 'empresa_ciudad',    'valor' => '',         'tipo' => 'string', 'grupo' => 'empresa', 'etiqueta' => 'Ciudad'],
