...
Briela nació como copia del sistema de origen con **historial de git nuevo**, así que los dos
...
**Último commit del sistema de origen ya incluido en Briela: `be22a1d`**
...
> saber qué falta sin revisar a mano todo el historial del sistema de origen.
...
dos proyectos. Es de lectura: nada de lo que se haga en Briela toca Briela.
...
Eso lista exactamente los commits del sistema de origen que todavía no están en Briela
...
El Briela **versiona `.claude/settings.local.json`**, que es estado local de la
...
| Todo lo de licencia, instalador y actualizador | No existe en Briela |
...
|---|---|
| Bug que detiene la operación del sistema de origen | En Briela, y se replica a Briela **el mismo día** |
| Mejora, módulo nuevo, refactor | **En Briela**, y de ahí se lleva al Briela |
